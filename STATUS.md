# 01-documentation-generator -- Implementation Status

**Last Updated**: 2026-03-03 by agent:copilot
**Data Model**: GET http://localhost:8010/model/projects/01-documentation-generator
...
# Project facts
Invoke-RestMethod "$base/model/projects/01-documentation-generator" | Select-Object id, maturity, phase, pbi_total, pbi_done
...
For veritas audit:
```
MCP tool: audit_repo  repo_path=C:\eva-foundry\01-documentation-generator
MCP tool: get_trust_score  repo_path=C:\eva-foundry\01-documentation-generator
```
...
**Data model record**: http://localhost:8010/model/projects/01-documentation-generator
...
1. Run veritas audit: `audit_repo` MCP tool, repo_path = C:\eva-foundry\01-documentation-generator
2. Check data model record: GET /model/projects/01-documentation-generator
3. Update PLAN.md with actual sprint stories
4. Fill ACCEPTANCE.md gate table with project-specific criteria
5. Commit first evidence: PUT /model/projects/01-documentation-generator with updated notes
