...
def save_evidence(evidence_data: Dict, output_path: Path):
    """Helper function to save evidence data to JSON file."""
    with open(output_path, "w", encoding="utf-8") as f:
        json.dump(evidence_data, f, indent=2)


def load_evidence(evidence_path: Path) -> Dict:
    """Helper function to load evidence data from JSON file."""
